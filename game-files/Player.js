class Player {
  ...
  cloneForData() {
    ...
    clone.bestScore = this.bestScore; //stores the this.score achieved used for replay
    clone.dead = this.dead;
    clone.kindaDead = this.kindaDead; //this is true when the player has died but deadcount isn't up
    ...
    clone.lastGrounded = this.lastGrounded;
